            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A"><?php echo ($enterInfo["name"]); ?><i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
                            <li><a href="#">切换账户</a></li>
                            <li><a href="<?php echo U('Enterprise/User/logout');?>">退出</a></li>
                        </ul>
                    </li>
        ...
        <dl id=menu-guidetable">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="<?php echo U('Enterprise/excellententerprise');?>" data-title="优秀企业表" href="javascript:void(0)">优秀企业表</a></li>
                </ul>
            </dd>
        </dl>
    </div>
