    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($name)): foreach($name as $key=>$vo): ?><tr class="text-c">
                ...
                <td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="" href="<?php echo U('Welinst/welfare/agree', ['id' => $vo['id'], 'mess_id' => $mess_id]);?>" title="同意"><span class='label label-success radius'>同意</span></a> <a style="text-decoration:none" class="ml-5"  href="" title="不同意"><span class='label label-danger radius'>不同意</span></a></td>
