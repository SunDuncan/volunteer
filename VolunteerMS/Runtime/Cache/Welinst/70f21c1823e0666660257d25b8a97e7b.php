    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td>1</td>
                <td>大集团</td>
                <td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="" href="javascript:;" title="同意"><span class='label label-success radius'>同意</span></a> <a style="text-decoration:none" class="ml-5"  href="" title="不同意"><span class='label label-danger radius'>不同意</span></a></td>
            </tr>
            </tbody>
        </table>
    </div>
