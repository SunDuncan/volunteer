...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-message">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('Welfare/welfare/add');?>" data-title="消息发布" href="javascript:void(0)">消息发布</a></li>
                    <li><a data-href="<?php echo U('Welfare/welfare/showlist');?>" data-title="消息列表" href="javascript:void(0)">消息列表</a></li>
                    <li><a data-href="<?php echo U('Welfare/welfare/applist');?>" data-title="消息申请列表" href="javascript:void(0)">消息申请列表</a></li>
                </ul>
            </dd>
        </dl>
